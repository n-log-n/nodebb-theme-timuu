            ...
            searchResults += `
                <div component="categories/category" data-cid="8" data-numrecentreplies="1" class="col-md-3 kralahmet">
                    <div class="kralahmet-container">
                        ...
                        <div class="kralahmet-bg" style="background-color: #DC9656; color: #fff; background-image: url(http://image.tmdb.org/t/p/w342/${media.poster_path}); background-size: cover;"></div>
                        <div class="content sicakhavalar">
                            <a href='#' id="media_link_${media.id}">
                                ...
                                <h2 class="title">
                                    <a class="div-href" href="/category/8/inception" itemprop="url"></a>
                                    <a href="/category/8/inception" itemprop="url">${media.title} (${media.year}) </b></a><br>
                                </h2>      
                            </a>
                        </div>
                    </div>
